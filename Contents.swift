...
class PokeDistanceTests: XCTestCase {
  func testFindShortestDistanceToPokemon() {
    //XCTAssertEqualWithAccuracy(YOUR CODE GOES HERE, 21.9, accuracy: 0.1)
  }
  
  func testFindNearestPokemonName() {
    //XCTAssertEqual(YOUR CODE GOES HERE, "Mewtwo")
  }
}
...
runner.runTests(testClass: PointTests.self)
runner.runTests(testClass: PokeDistanceTests.self)